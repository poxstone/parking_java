...
public class PoputaleController {
	...
	public String  populateAll() {
		...
		putHttp(HOST_URL+"/clientes/add", jsonCliente1, HttpMethod.PUT);
		...
		putHttp(HOST_URL+"/operadores/add", jsonOperador1, HttpMethod.PUT);
		...
		putHttp(HOST_URL+"/recaudos/add", jsonRecaudo1, HttpMethod.PUT);
